	...
	public class QuestManager {
		...
		public static function showPrompt():void {
			...
			try {
				...
				if (com.aqwapi.AqwApi.game && com.aqwapi.AqwApi.game.ui) {
					com.aqwapi.AqwApi.game.ui.addChild(_promptContainer);
				} else if (com.aqwapi.AqwApi.game != null) {
						com.aqwapi.AqwApi.game.addChild(_promptContainer);
					}
			} catch (err:Error) {
				if (com.aqwapi.AqwApi.game && com.aqwapi.AqwApi.game.MsgBox) {
		...
		private static function onTick(e:TimerEvent):void {
			if (!com.aqwapi.AqwApi.game || !com.aqwapi.AqwApi.game.world) return;
